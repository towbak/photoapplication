...
<!DOCTYPE html>
<html>
    <jsp:useBean id="photoAlbum" scope = "session" class="photos.PhotoAlbum" />
    <jsp:setProperty name="photoAlbum" property="session"
                                       value="<%=session%>" />
	<head>
	  ...
	  <table>
	      <tr>
	          <c:forEach var="i" begin="1" end="${photoAlbum.photoCount}">
	              <td align='center'>
	                  <photo-tags:photo width='150' height='120'
	                                    index='${i-1}'></photo-tags:photo>
	              </td>
	          </c:forEach>
